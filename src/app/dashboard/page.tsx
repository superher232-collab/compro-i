        ...
        <div style={{ background: 'rgba(20, 10, 36, 0.7)', border: '1px solid rgba(168, 85, 247, 0.3)', borderRadius: '4px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '12px', borderRadius: '4px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '10px', color: 'white', fontWeight: 'bold' }}>MV PACIFIC STAR</span>
                <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#22C55E' }}></div>
              </div>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>Pacific Ocean</span>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>ETA: 2 jam</span>
            </div>

            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '12px', borderRadius: '4px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '10px', color: 'white', fontWeight: 'bold' }}>MV ATLANTIC PRIDE</span>
                <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#3B82F6' }}></div>
              </div>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>Port of Rotterdam</span>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>ETA: Tiba</span>
            </div>

            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '12px', borderRadius: '4px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '10px', color: 'white', fontWeight: 'bold' }}>MV INDIAN OCEAN</span>
                <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#F59E0B' }}></div>
              </div>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>Arabian Sea</span>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>ETA: 4 jam</span>
            </div>

            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '12px', borderRadius: '4px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '10px', color: 'white', fontWeight: 'bold' }}>MV CORAL SEA</span>
                <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#22C55E' }}></div>
              </div>
              <span style={{ fontSize: '9px', color: 'var(--text-muted, #8B7BA8)' }}>South China Sea</span>
